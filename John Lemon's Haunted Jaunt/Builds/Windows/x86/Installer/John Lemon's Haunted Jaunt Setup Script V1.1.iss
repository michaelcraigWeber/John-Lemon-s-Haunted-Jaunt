...
#define MyAppExeName "John Lemon's Haunted Jaunt (Tutorial).exe"

[Setup]
; NOTE: The value of AppId uniquely identifies this application. Do not use the same AppId value in installers for other applications.
; (To generate a new GUID, click Tools | Generate GUID inside the IDE.)
AppId={{8BA25868-1802-4C07-8EBD-BD2451D3248D}
AppName={#MyAppName}
...
OutputBaseFilename=John Lemon's Haunted Jaunt Setup (x86) V1.1
Compression=lzma
...
[Files]
Source: "C:\Users\micha\John Lemon's Haunted Jaunt\Builds\Windows\x86\John Lemon's Haunted Jaunt (Tutorial).exe"; DestDir: "{app}"; Flags: ignoreversion
